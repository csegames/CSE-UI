...
import { getStringTableValue, StringIDGeneralCancel, StringIDGeneralCommit } from '../helpers/stringTableHelpers';
...
// String IDs
const StringIDPlacementTitle = 'PlacementTitle';
const StringIDPlacementTranslate = 'PlacementTranslate';
const StringIDPlacementRotate = 'PlacementRotate';
const StringIDPlacementReset = 'PlacementReset';
...
class APlacement extends React.Component<Props, State> {
    ...
    const icons = [
      {
        ...
        text: getStringTableValue(StringIDPlacementTranslate, this.props.stringTable),
      ...
      },
      {
        ...
        text: getStringTableValue(StringIDPlacementRotate, this.props.stringTable),
      ...
      },
      {
        ...
        text: getStringTableValue(StringIDPlacementReset, this.props.stringTable),
    ...
    return (
      <div className={Root}>
        <Menu
          ...
          title={getStringTableValue(StringIDPlacementTitle, this.props.stringTable)}
          menuID={WIDGET_ID_PLACEMENT}
  ...
  getFooterButtons(): FooterButtonData[] {
    return [
      {
        text: getStringTableValue(StringIDGeneralCommit, this.props.stringTable),
...
export const WIDGET_ID_PLACEMENT = 'Placement';
export const placementRegistry: HUDWidgetRegistration = {
  id: WIDGET_ID_PLACEMENT,
  nameStringID: 'HUDEditorWidgetNamePlacement',
  defaults: {
  ...
  render: (isDragCopy: boolean) => {
    return <Placement isDragCopy={isDragCopy} />;
  }
};
