...
export default function(props: Props) {
  ...
  const vikingLayerInfo = [
    ...
    { id: 'snow', particleEffect: snowParticleDef },
  ...
  const tddLayerInfo = [
    ...
    { id: 'glowOrbs', particleEffect: orbsParticleDef },
