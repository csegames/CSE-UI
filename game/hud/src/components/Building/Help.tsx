  ...
  return (
    <Container className='cse-ui-scroller-thumbonly'>
      ...
      <Control>
        ...
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeCommitBlock).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Commit Action - Place (in Placement Mode) or Remove (in Selection Mode)</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeUndoBlockPlacement).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Deselect blocks</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeRotateBlockX).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Rotate 90&deg; around the X axis</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeRotateBlockY).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Rotate 90&deg; around the Y axis</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeRotateBlockZ).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Rotate 90&deg; around the Z axis</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeFlipBlockX).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Flip X faces</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeFlipBlockY).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Flip Y faces</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeFlipBlockZ).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Flip Z faces</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeCycleSelectedBlockShape).binds[0].name}
          </ControlKeybind>
        ...
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeBuildingCopy).binds[0].name}
          </ControlKeybind>
          <ControlLabel>Copy selected blocks as a temporary blueprint</ControlLabel>
        </Control>
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.CubeBuildingPaste).binds[0].name}
          </ControlKeybind>
      ...
      <Extra>
        ...
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.UIHideToggle).binds[0].name}
          </ControlKeybind>
        ...
        <Control>
          <ControlKeybind>
            {game.getKeybindSafe(game.keyActions.UIToggleBuildingMode).binds[0].name}
          </ControlKeybind>
