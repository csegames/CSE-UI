...
//   const res =
//    await webAPI.WarbandsAPI.QuitV1(webAPI.defaultConfig, client.loginToken, client.shardID, client.characterID);
//   if (!res.ok) {
//     // something went wrong
//     console.error(res);
//     return;
...
//        ' Will use either your current friendly target, or a character name if you provide one.',
//     (name: string = '') => {
//       if (name.length > 0) {
//         inviteByName(name);
