...
import SplitStackMenu from '../../Inventory/components/ContextMenu/SplitStackMenu';
import dragAndDrop, {
  DraggableOptions,
  DragEvent,
  StartDragOptions,
...
import { getInventoryDataTransfer } from 'widgets/HUDFullScreen/lib/utils';
import { InventoryDataTransfer } from 'widgets/HUDFullScreen/lib/itemEvents';
