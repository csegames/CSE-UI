...
import { SlotNumberToItem, DrawerSlotNumberToItem } from 'widgets/HUDFullScreen/components/ItemShared/InventoryBase';
import { ContainerSlotItemDef, SlotType } from 'widgets/HUDFullScreen/lib/itemInterfaces';
