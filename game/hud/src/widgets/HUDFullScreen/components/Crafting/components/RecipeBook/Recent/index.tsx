...
class Recent extends React.Component<Props, State> {
  ...
  private renderView = () => {
    ...
    return (
      <GroupLogQuickView
        ...
        groupLogs={this.getRecentGroupLogs()}
  ...
  private getRecentGroupLogs = () => {
    const groupLogs = this.props.groupLogs.sort((a, b) => {
      const aDate = new Date(a.log.lastCrafted) as any;
      const bDate = new Date(b.log.lastCrafted) as any;
      return bDate - aDate;
    });
