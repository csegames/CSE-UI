...
import { testArmorItem } from '../../test';
...
describe('<TooltipContent />', () => {
  ...
  test('Matches Snapshot', async () => {
    const component = mount(<TooltipContent item={testArmorItem} />);
  ...
  test('Display slotName prop if given rather than gearSlot', async () => {
    const component = mount(<TooltipContent item={testArmorItem} slotName={'face'} />);
