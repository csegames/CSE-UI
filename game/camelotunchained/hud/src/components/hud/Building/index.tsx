...
import { TabbedDialog, DialogButton } from 'cseshared/components/TabbedDialog';
...
export class Build extends React.PureComponent<BuildProps, BuildState> {
  ...
  public componentDidMount() {
    this.openToggleHandle = camelotunchained.game.onToggleBuildSelector(this.toggleVisibility);
    this.buildingModeHandle = camelotunchained.game.onBuildingModeChanged(this.handleBuildingModeChanged);
  }
