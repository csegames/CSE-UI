      ...
      <GraphQL query={{ query, pollInterval: 5000 }}>
        {(graphql: GraphQLResult<MiniScenarioScoreboardQuery.Query>) => {
          ...
          return (
            <Wrapper>
              <Container>
                <ArthurianBackground active={camelotunchained.game.selfPlayerState.faction === Faction.Arthurian}>
                  {scoreboard.teams.arthurian.score}
                </ArthurianBackground>
                <TddBackground active={camelotunchained.game.selfPlayerState.faction === Faction.TDD}>
                  {scoreboard.teams.tdd.score}
                </TddBackground>
                <VikingBackground active={camelotunchained.game.selfPlayerState.faction === Faction.Viking}>
