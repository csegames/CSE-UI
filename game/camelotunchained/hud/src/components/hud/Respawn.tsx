...
export class Respawn extends React.Component<Props, State> {
  ...
  public componentDidMount() {
    ...
    this.evh = camelotunchained.game.selfPlayerState.onUpdated(this.handleVisibility);
  }
  ...
  private handleVisibility = () => {
    if (!camelotunchained.game.selfPlayerState.isAlive && !this.state.visible) {
  ...
  private onRespawnClick = () => {
    camelotunchained.game.selfPlayerState.respawn('-1');
  }
}
