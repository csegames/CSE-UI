...
class Welcome extends React.Component<WelcomeProps, WelcomeState> {
  ...
  private initMotd = (motd: MessageOfTheDay) => {
    ...
    try {
      ...
      const motdStoragePayload = localStorage.getItem(
        `${STORAGE_PREFIX}-${camelotunchained.game.selfPlayerState.characterID}`);
  ...
  private onHideDelayClick = (motd: MessageOfTheDay): void => {
    ...
    localStorage.setItem(
      `${STORAGE_PREFIX}-${camelotunchained.game.selfPlayerState.characterID}`, JSON.stringify(motdStoragePayload));
  }
}
