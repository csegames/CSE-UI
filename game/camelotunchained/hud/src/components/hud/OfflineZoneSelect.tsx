...
export class OfflineZoneSelect extends React.PureComponent<{}> {
  ...
  constructor(props: {}) {
    ...
    this.eventHandle = camelotunchained.game.offlineZoneSelectState.onUpdated(this.stateChanged);
  }

  public render() {
    const { zones, visible } = camelotunchained.game.offlineZoneSelectState;
          ...
          <ZoneSelectWrapper>
            {
              Object
                ...
                .map(z => <Zone
                    ...
                    onClick={() => camelotunchained.game.offlineZoneSelectState.selectZone(z.id)}>{z.name}</Zone>)
            }
          </ZoneSelectWrapper>
        </Overlay>
