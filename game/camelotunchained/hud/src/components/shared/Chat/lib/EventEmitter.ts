...
class EventEmitter {
   ...
   */
  public addListener(topic: string, once: boolean = false, callback: (data: any) => void): any {
   ...
   * @param callback {function}    Handler to call when topic is fired
   */
  public on(topic: string, callback: (data: any) => void): any {
   ...
   * @param callback {function}    Handler to call when topic is fired
   */
  public listenOnce(topic: string, callback: (data: any) => void): any {
