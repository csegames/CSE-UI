...
import TabHeader from 'shared/Tabs/TabHeader';
...
import { isStackedItem, isCraftingItem, isContainerItem, getItemMapID } from 'fullscreen/lib/utils';
import { ContainerIdToDrawerInfo, getContainerIdToDrawerInfo } from 'fullscreen/ItemShared/InventoryBase';
  ...
  private onCancelClick = async () => {
    try {
      ...
      if (res.ok) {
        ...
        camelotunchained.game.sendPassiveAlert('Trade Canceled');
