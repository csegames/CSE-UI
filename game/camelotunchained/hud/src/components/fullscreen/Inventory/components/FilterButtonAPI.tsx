...
import { defaultFilterButtonIcons } from 'fullscreen/lib/utils';
import { InventoryFilterButton } from 'fullscreen/lib/itemInterfaces';

const inventoryFilterButtonLocalStorageKey =  `inventoryFilterButton${camelotunchained.game.selfPlayerState.characterID}`;
