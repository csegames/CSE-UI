...
class GeneralInfo extends React.PureComponent<GeneralInfoProps, GeneralInfoState> {
  ...
  public render() {
    ...
    return (
      <Container style={{ backgroundImage: `url(${this.paperdollBG})` }}>
        ...
        <BottomRightOrnament />
        <Content>
          <Name>{camelotunchained.game.selfPlayerState.name}</Name>
          <InfoContainer>
            <CharacterInfo>
              <Text className='nowrap'>
                {Faction[camelotunchained.game.selfPlayerState.faction]}
              </Text>
              <Text className='nowrap'>
                {Gender[camelotunchained.game.selfPlayerState.gender]} {webAPI
                  .raceString(camelotunchained.game.selfPlayerState.race)}
              </Text>
              <Text className='nowrap'>
                {Archetype[camelotunchained.game.selfPlayerState.classID]}
              </Text>
            </CharacterInfo>
            <InfoDivider />
            <BiographyInfo>
  ...
  private shouldZoom = () => {
    const race = camelotunchained.game.selfPlayerState.race;
    const archetype = camelotunchained.game.selfPlayerState.classID;
