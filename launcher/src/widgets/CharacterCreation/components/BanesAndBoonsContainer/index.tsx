...
import { Archetype, Race } from '../../../../api/helpers';
  ...
  private onResetClick = (initType: 'banes' | 'boons' | 'both') => {
    ...
    dispatch(
      resetBaneOrBoon({
        ...
        playerClass: Archetype[playerClass.selected.stringID as keyof typeof Archetype],
        race: Race[race.selected.stringID as keyof typeof Race],
