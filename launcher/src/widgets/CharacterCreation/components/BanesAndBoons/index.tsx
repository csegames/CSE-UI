...
class BanesAndBoons extends React.Component<BanesAndBoonsProps, BanesAndBoonsState> {
  ...
  public render() {
    ...
    const allBoons = [
      ...
      ...Object.keys(this.props.generalBoons)
    ...
    const allBanes = [
      ...
      ...Object.keys(this.props.generalBanes)
        .map((id: string) => traits[id])
    ...
    const boonPoints =
      (Object.keys(addedBoons).length > 0 &&
        Object.keys(addedBoons)
          .map((id: string) => traits[id].points)
          .reduce((a, b) => a + b)) ||
      0;
    const banePoints =
      (Object.keys(addedBanes).length > 0 &&
        Object.keys(addedBanes)
          .map((id: string) => traits[id].points * -1)
          .reduce((a, b) => a + b)) ||
      0;
    const allAddedTraits = Object.assign({}, addedBoons, addedBanes);
    return (
      <Container>
        <TraitListContainer
          type={'boon'}
