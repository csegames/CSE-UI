      ...
      <div>
        <ResetAlertOverlay
          style={{
            ...
            visibility:
              showResetBoonAlertDialog || showResetBaneAlertDialog || showResetAllAlertDialog ? 'visible' : 'hidden'
          }}
        />
        <ResetAlertDialog
          style={{
        ...
        >
          ...
          <ResetAlertButtonContainer>
            ...
            <ResetAlertButton onClick={this.onReset.bind(this)}>Yes, reset!</ResetAlertButton>
          </ResetAlertButtonContainer>
        </ResetAlertDialog>
      </div>
    );
