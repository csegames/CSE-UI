...
import { Faction, FactionInfo } from '../../../api/webapi';
  ...
  private generateFactionContent = (info: FactionInfo) => {
    ...
    return (
      <div
        ...
        className={`cu-character-creation__faction-select__${info.shortName} ${
          this.props.selectedFaction !== null ? (this.props.selectedFaction.id === info.id ? 'active' : '') : ''
        }`}
