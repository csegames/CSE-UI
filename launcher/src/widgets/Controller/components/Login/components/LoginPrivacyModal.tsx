      ...
      <Container>
        ...
        >
          <Modal>
            ...
            <ModalText>
              <Section>
                Our privacy policy has changed. In order to access the game, you must accept these changes on the CSE
                account webpage
              ...
              <Section>
                If you would like to edit your privacy settings, go to the account page. Under the Privacy Policy
                section, there is a 'Privacy Settings' link. Click on it and follow the directions.
              </Section>

              <Section>
                You can also edit your privacy settings by clicking 'Edit Account Details'. Then click 'Privacy
                Settings'.
              </Section>
            </ModalText>
