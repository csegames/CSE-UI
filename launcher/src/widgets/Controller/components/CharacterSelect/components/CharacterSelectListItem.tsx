...
import { SimpleCharacter, Race, Gender, Archetype, raceString, archetypeString } from '../../../../../api/helpers';
...
class CharacterSelectListItem extends React.Component<CharacterSelectListItemProps, CharacterSelectListItemState> {
  ...
  public render() {
    ...
    const race =
      !character.race || includes(Race[character.race].toLowerCase(), 'human') ? 'Human' : Race[character.race];
  ...
  private toggleDeleteModal = (e?: React.MouseEvent<HTMLDivElement>) => {
    ...
    globalEvents.trigger('character-select-show-delete');
  };
  ...
  private renderCharImg = (charIdentifier: string, classImg: string) => {
    switch (charIdentifier) {
      ...
      case 'GolemMaleMinstrel':
      case 'GolemFemaleMinstrel':
      case 'StrmMaleMinstrel':
      case 'StrmFemaleMinstrel':
      case 'CaitSithMaleMinstrel':
      case 'CaitSithFemaleMinstrel': {
      ...
      case 'FirbogMaleDruid':
      case 'FirbogFemaleDruid':
      case 'HamadryadMaleDruid':
      case 'HamadryadFemaleDruid': {
