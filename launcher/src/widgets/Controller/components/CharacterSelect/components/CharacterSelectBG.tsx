...
import { SimpleCharacter, Race, Archetype, raceString, archetypeString } from '../../../../../api/helpers';

const Faction = shard.Faction;
      ...
      return (
        <div id='char-select-fx'>
          ...
          <CharImg
            ...
            style={{
              height:
                selectedCharacter.race === Race.Luchorpan || selectedCharacter.archetype === Archetype.WintersShadow
                  ? '65%'
                  : '80%',
          ...
          >
            ...
            <CharacterMetaInfo>
              {archetypeString(Archetype[selectedCharacter.archetype])} - {raceString(selectedCharacter.race)}
            </CharacterMetaInfo>
          </CharacterInfoOverlay>
        </div>
      );
  ...
  public componentWillReceiveProps(nextProps: CharacterSelectBGProps) {
    if (this.props.selectedCharacter && nextProps.selectedCharacter) {
      ...
      if (this.props.selectedCharacter.id !== nextProps.selectedCharacter.id) {
        this.playTransitionAnimation();
        if (
          this.props.selectedCharacter.faction !== nextProps.selectedCharacter.faction ||
