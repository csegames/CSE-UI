...
const BarContainer = styled.div`
  ...
  left: 0px;
  z-index: 2;
  background: url(/ui/images/controller/texture-overlay.png), linear-gradient(black, #272727);
...
const ProgressText = styled.div`
  ...
  padding: 3px 10px;
  color: #c3c3c3;
  background: url(/ui/images/controller/loading-percent.png);
  display: block;
  position: absolute;
  top: -2px;
  left: -2px;
...
const Bar = styled.div`
  ...
  &:after {
    content: '';
    background: url(/ui/images/controller/loading-bar-end.png) no-repeat center right;
    width: 200px;
    height: 10px;
    margin-top: 2px;
  }
  ...
  &:before {
    content: '';
    background: url(/ui/images/controller/loading-bar-repeat.png) center;
    width: 100%;
    height: 10px;
    margin-top: 2px;
  }
