...
export function GettingStarted(props: Props) {
  ...
  if (props.phase !== ContentPhase.Camelot) return null;
  ...
  return (
    <Container>
      ...
      <LinksContainer>
        ...
        <Link target='_blank' href='https://s3.amazonaws.com/camelot-unchained/docs/French-Beta-1-Players-Guide.pdf'>
          French Beta 1 Guide
        </Link>
        <Link target='_blank' href='https://s3.amazonaws.com/camelot-unchained/docs/German-Beta-1-Players-Guide.pdf'>
          German Beta 1 Guide
        </Link>
      </LinksContainer>
    </Container>
