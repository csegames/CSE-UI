...
import { events, Faction, Race, Archetype } from '@csegames/camelot-unchained';
...
export class CharacterSelectEffects extends React.PureComponent<Props, State> {
  ...
  public componentDidMount() {
    this.eventHandle = events.on('view-content', this.handleViewContent);
  }

  public componentWillUnmount() {
    events.off(this.eventHandle);
  }
