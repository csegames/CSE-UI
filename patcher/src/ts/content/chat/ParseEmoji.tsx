...
function emojiNameFromText(text:string): string {
  ...
  switch(text.toLowerCase()) {
    ...
    case ':jbhead:': case ':jb:':
      return 'jbhead';
    case ':markhead:': case ':mj:': case ':mark:':
      return 'markhead';
    case ':mjelf:':
      return 'mjelf';
    case ':sandragrin:':
    ...
    case ':arthurianlove:': case ':artlove:':
      return 'arthurianlove';
    case ':tuathalove:': case ':tddlove:':
      return 'tuathalove';
    case ':vikinglove:': case ':viklove:':
      return 'vikinglove';
    ...
    case ':salt:':
      return 'salt';
    case ':arthurianshield:': case ':artshield:':
      return 'arthurianshield';
    case ':tuathashield:': case ':tddshield:':
      return 'tuathashield';
    case ':vikingshield:': case ':vikshield:':
      return 'vikingshield';
    case ':shotsfired:':
      return 'shotsfired';
    case ':unicorn:':
