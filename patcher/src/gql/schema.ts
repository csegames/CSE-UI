...
/** CU.WebApi.GraphQL.IGroupNotification */
...
export interface StatusStackingDef {
  group: string | null;
  refreshTimedDurations: boolean | null;
...
export interface ActiveGroupUpdatesactiveGroupUpdatesArgs {
  groupID: string | null;
}
export interface PatcherAlertspatcherAlertsArgs {
  onShard:
...
export enum Archetype {
  ...
  Charlotte = "Charlotte",
  PerftestMeleeAttacker = "PerftestMeleeAttacker",
  PerftestRangedAttacker = "PerftestRangedAttacker",
  PerftestDefender = "PerftestDefender",
  Admin = "Admin",
  Test = "Test",
  Any = "Any"
}
...
/** CU.WebApi.GraphQL.GroupNotificationType */
