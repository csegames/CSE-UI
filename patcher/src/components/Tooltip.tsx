...
import { Quadrant, windowQuadrant } from '@csegames/library/lib/_baseGame/utils/layoutLib';
...
export class Tooltip extends React.Component<TooltipProps, TooltipState> {
      ...
      <Container style={customStyles.Tooltip}>
        ...
        </div>
        {
          showTooltip ?
            !fixed ?
              <TooltipView
                innerRef={(ref: any) => this.tooltipRef = ref}
  ...
  private computeStyle = (x: number,
    ...
    if (this.props.fixedMode && this.tooltipDimensions) {
      const { width, height } = this.childRef.getBoundingClientRect();
      switch (wndRegion) {
