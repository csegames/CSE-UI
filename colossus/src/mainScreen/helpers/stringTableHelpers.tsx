...
export const StringIDGeneralLocked = 'GeneralLocked';
...
export const StringIDGeneralRequirements = 'GeneralRequirements';
export const StringIDGeneralPan = 'GeneralPan';
export const StringIDGeneralReset = 'GeneralReset';
export const StringIDGeneralZoom = 'GeneralZoom';
