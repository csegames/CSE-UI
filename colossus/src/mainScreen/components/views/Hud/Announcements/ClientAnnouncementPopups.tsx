...
const ObjectiveSuccessMessage = 'Announcements-ClientPopups-ObjectiveSuccessMessage';
const ObjectiveFailedMessage = 'Announcements-ClientPopups-ObjectiveFailedMessage';
...
class AClientAnnouncementPopups extends React.Component<Props, State> {
  ...
  public render() {
    ...
    return (
      <div id='ClientAnnouncementPopupsContainer_HUD' className={`${Container} ${popups.length === 0 ? 'empty' : ''}`}>
        <CSSTransitionGroup
...
export const ClientAnnouncementPopups = connect(mapStateToProps)(AClientAnnouncementPopups);
