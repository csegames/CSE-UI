...
export function raceString(race: def.Race) {
  switch (race) {
    case def.Race.Tuatha:
      return 'Tuatha';
    case def.Race.Hamadryad:
      return 'Hamadryad';
    case def.Race.Luchorpan:
      return 'Luchorpán';
    case def.Race.Firbog:
      return 'Fir Bog';
    case def.Race.Valkyrie:
      return 'Valkyrie';
    case def.Race.Helbound:
      return 'Helbound';
    case def.Race.FrostGiant:
      return 'Jötnar';
    case def.Race.Dvergr:
      return 'Dvergar';
    case def.Race.Strm:
      return 'St`rm';
    case def.Race.CaitSith:
      return 'Cait Sith';
    case def.Race.Golem:
      return '';
    case def.Race.Gargoyle:
      return 'Gargoyle';
    case def.Race.StormRider:
      return 'Stormrider';
    case def.Race.StormRiderT:
      return 'Stormrider';
    case def.Race.StormRiderV:
      return 'Stormrider';
...
export function archetypeString(archetype: def.Archetype) {
  switch (archetype) {
    case def.Archetype.FireMage:
      return 'Fire Mage';
    case def.Archetype.EarthMage:
      return 'Earth Mage';
    case def.Archetype.WaterMage:
      return 'Water Mage';
    case def.Archetype.Fighter:
      return 'Fighter';
    case def.Archetype.Healer:
      return 'Healer';
    case def.Archetype.MeleeCombatTest:
      return 'Melee Test';
    case def.Archetype.Archer:
      return 'Archer';
    case def.Archetype.ArcherTest:
      return 'Archer Test';
