...
export default function() {
  ...
  engineInit(
    ...
    initDefault,
    () => camelotunchained.game.offlineZoneSelectState,
    (model: OfflineZoneSelectStateModel) => camelotunchained._devGame.offlineZoneSelectState =
      model as OfflineZoneSelectState);
