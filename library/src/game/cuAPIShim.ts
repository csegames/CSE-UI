...
function cuAPIShim() {
  return {
    ...
    OnSkillStateChanged: (callback: (skillState: any) => void): void => {},

    OnSkillBarChanged: (callback: (newSkillBar: any[]) => void): void => {},
    ...
    OnGearAdded: (callback: (item: any) => void): void => {
    },
    ...
    OnInventoryAdded: (callback: (item: any) => void): void => {
    },
    ...
    RestoreConfigDefaults: (tag: any): void => {
    },
    ChangeConfigVar: (variable: string, value: string): void => {
    },
    CancelChangeConfig: (variable: string): void => {
    },
    CancelAllConfigChanges: (tag: any): void => {
    },
    GetConfigVars: (tag: any): void => {
    },
    GetConfigVar: (variable: string): void => {
    },
    RequestDisplayModes: (): void => {
    },
    OnDisplayModesChanged: (c: (displayModes: any[]) => void): void => {
    },
    ...
    /* Scenarios */
    ScenarioRoundEnded: (c: (scenarioID: string, roundID: string, scenarioEnded: boolean, didWin: boolean) => void) => {
    },
    ...
    OnAllKeybindsRequested: (callback: (bindables: any[], bindings: Binding[]) => void) => {},
    RequestAllKeybinds: () => {},
