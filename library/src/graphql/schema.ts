...
export interface ProgressionData {
  shardProgression: ShardSummaryDBModel | null;
  shardDays: Array<ShardDaySummaryDBModel> | null;
  characterProgression: CharacterSummaryDBModel | null;
  unhandledDayLogs: Array<CharacterDaySummaryDBModel> | null;
  dayLogByID: CharacterDaySummaryDBModel | null;
  characterDays: Array<CharacterDaySummaryDBModel> | null;
}

export interface ShardDaysProgressionDataArgs {
  startDate: Date | null;
  endDate: Date | null;
}

export interface DayLogByIdProgressionDataArgs {
  logID: string | null;
}

export interface CharacterDaysProgressionDataArgs {
  startDate: Date | null;
  endDate: Date | null;
}
...
export interface CharacterSummaryDBModel {
  ...
  totalActiveDayCount: number | null;
  totalSecondsActive: number | null;
  totalDistanceMoved: number | null;
}
...
export interface CharacterDaySummaryDBModel {
  ...
  skillPartsUsed: Array<SkillPartUsed> | null;
  state: States | null;
}
