...
export enum SoundEvents {
  ...
  PLAY_UI_MAIN_MENU_CONFIRM_WINDOW_POPUP_NO = 309512120,
  PLAY_UI_MAIN_MENU_CONFIRM_WINDOW_POPUP_YES_FAILURE = 2411850041,
  ...
  PLAY_UI_MAIN_MENU_TAB_CHAMPION_NINJA = 3044067340,
  ...
  PLAY_UI_MAIN_MENU_CHARACTER_SELECT_LOCK_IN = 1626971452,
